...
-- The dashboard must have a button at the bottom titled "Fix Schedule" that edits the schedule text in the transfer editor. The "Fix Schedule" button will only change the schedules in the transfer editor for people that had any part of their data edited in the dashboard.
