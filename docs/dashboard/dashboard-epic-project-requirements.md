# Dashboard Epic project requirements

Dashboard epic project requirements:

- This system functions as a partial database for storing people's information and providing easy, user-friendly access to that information.
-- The application reads data from a Microsoft Excel spreadsheet, then organizes and displays it for the user.
-- The user will be able to quickly search, filter, and sort through all available information.
